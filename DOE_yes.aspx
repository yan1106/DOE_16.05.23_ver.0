...
.font6
    ...
    <script type="text/javascript">
        ...
        function Add_Row(row)
        {
            ...
            var rowspan_0 = document.getElementById('doe_1').rows[but_save_row[i]].cells[0].rowSpan = temp_count;
            var rowspan_1 = document.getElementById('doe_1').rows[but_save_row[i]].cells[1].rowSpan = temp_count;
            var rowspan_2 = document.getElementById('doe_1').rows[but_save_row[i]].cells[2].rowSpan = temp_count;
            var rowspan_4 = document.getElementById('doe_1').rows[but_save_row[i]].cells[3].rowSpan = temp_count;
            var rowspan_5 = document.getElementById('doe_1').rows[but_save_row[i]].cells[4].rowSpan = temp_count;
